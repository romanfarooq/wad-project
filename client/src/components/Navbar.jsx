    ...
    <>
      <nav className="fixed top-0 bottom-0 left-0 w-1/5 bg-[#f5f6fc] rounded-r-3xl shadow-inner">
        <div className="flex m-5 pb-3 border-b-2 border-blue-100">
          ...
          <h1 className="hidden sm:block sm:text-sm md:text-base lg:text-lg xl:text-2xl m-auto ml-1 text-[#153a75] font-extrabold">
            TO-DO APP
          </h1>
        </div>
        <div className="flex h-16 flex-col xl:flex-row sm:h-32 xl:h-24 justify-center items-center">
          <img
            ...
            alt="profile-pic"
          />
          <div className="hidden sm:flex text-center xl:text-left flex-col justify-center text-[#153a75]">
        ...
        <div className="flex flex-col gap-3">
          {NavItems.map((item, index) => (
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? 'flex items-center gap-2 px-2 justify-center sm:justify-start md:px-5 py-2 rounded-r-md bg-[#ebecf5] border-r-8 border-[#234d92] text-[#153a75] font-bold'
                  : 'flex items-center gap-2 px-2 justify-center sm:justify-start md:px-5 py-2 rounded-r-md hover:bg-[#ebecf5] hover:border-r-8 transition duration-200 border-[#234d92] text-[#153a75] font-medium hover:font-bold'
              }
            >
              {item.icon}
        ...
        <div className="fixed bottom-0 left-0 w-1/5">
          <div className="flex flex-col w-full l-md:flex-row gap-2 px-3 lg:px-5 py-4">
            <MdDarkMode
              className="text-2xl m-auto sm:m-0 sm:mt-1 cursor-pointer sm:cursor-default text-[#2196F3]"
              onClick={() => console.log('clicked')}
            />
            <div className="hidden sm:flex">
              <span className="block my-auto text-xs md:text-sm lg:text-base xl:text-xl font-medium text-[#153a75]">
                Dark Mode
              </span>
              <label
                htmlFor="checkbox"
